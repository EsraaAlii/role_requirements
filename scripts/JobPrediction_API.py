...
CLUSTERS_YAML_PATH = r"data\processed\features_skills_clusters_description.yaml"
...
app = Flask(__name__)
job_model = JobPrediction(mlflow_uri=MLFLOW_TRACKING_URI,run_id=MLFLOW_RUN_ID , exp_id= EXP_ID ,clusters_yaml_path= CLUSTERS_YAML_PATH)
...
def predict_jobs_probs():
    ...
    predictions = job_model.predict_jobs_probs(available_skills).to_dict()
    return jsonify(predictions)


#create simulation/recomm endpoint
